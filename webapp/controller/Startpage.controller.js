sap.ui.define([
	...
	return Controller.extend("sap.suite.ui.commons.demokit.tutorial.icecream.01.controller.Startpage", {
		...
		onInit: function () {
			var sDataPath = jQuery.sap.getModulePath("sap.suite.ui.commons.demokit.tutorial.icecream.01.model.data", "/News.json");
		...
		toFreestyle: function() {
			this.getRouter().navTo("freestyle");
		},
